...
- Left border: 6px solid (color-coded by principle or section type)
- Visible 1px borders on all sides
- Compact padding (16-20px)
- No soft shadows — flat with border delineation

**Chips/Tags:**
- Square/block shapes, never fully rounded pills
- Status encoded via color + 10% background tint
- 2px border radius maximum
- Monospace field IDs alongside human-readable labels

**Navigation Buttons:**
- Minimal rounding (2px)
- Sharp or no shadows
- Active state with solid background fill
- No hover lift/translate effects

**Rating Scale:**
- Flat grid with visible borders
- Block-shaped option cards
- Color-coded dots for scoring levels

**Tables:**
- Sticky headers with strong bottom border
- Visible grid lines (both vertical and horizontal)
- Compact padding
- Row hover with 10% tint highlighting
